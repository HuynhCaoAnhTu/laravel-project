...
Route::post('/update-cart-in-payment','CartController@update_cart_in_payment');
// Check out 
...
Route::get('/acpect-order/{order_id}','AdminController@acpect_order');
Route::get('/back_to_manage_order','AdminController@back_manage_order');
?>