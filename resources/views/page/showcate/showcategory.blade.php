...
<div class="features_items"><!--features_items-->
            @foreach ( $category_name as$key => $cate_name )
                ...
                <h2 style="margin-top: 5px" class="title text-center">Danh mục {{ $cate_name->category_name }}</h2>
                @endforeach
                <div class="row" style=" margin-bottom: 10px">
                    ...
                    <div class="col-md-2">
                     ...
                     <button   style="  font-size: 14px " class="btn btn-fefault cart">
                         <a  href="{{  url()->current()}}?sort_by=tag2"  href="đâsd" style="font-style: none; color: aliceblue">   
                             100.000-200.000</a>
                    ...
                    <div class="col-md-2">
                     <button   style=" font-size: 14px" class="btn btn-fefault cart">
                         <a href="{{  url()->current()}}?sort_by=tag3"  href="đâsd" style="font-style: none; color: aliceblue">   300.000-500.000 </a>
                     
                     </button>
                     <button   style=" font-size: 14px" class="btn btn-fefault cart">
                         <a  href="{{  url()->current()}}?sort_by=tag4" href="đâsd" style="font-style: none; color: aliceblue">  > 500.000</a>
                ...
                <div class="col-sm-4">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                                <div class="productinfo text-center" style="height: 455px">
