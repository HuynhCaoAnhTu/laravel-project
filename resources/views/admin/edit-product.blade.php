                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ URL::to('/update-product/'.$pro->product_id) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="product_desc" style="resize: none" id="editor1" rows="8" class="form-control">{{ $pro->product_desc }} </textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội dung sản phẩm </label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="product_quality" value="{{ $pro->product_quality }}">
                        </div>
